  ...
  return (
    <main className="flex flex-col items-center justify-between">
      <div 
        ...
        className="w-full bg-gray-300 px-5 sm:px-20 py-80 relative text-white flex flex-col justify-center items-center text-center">
        <h1 className=' relative z-10 text-7xl font-bold py-6'>E1K Urakointi Oy</h1>
        <h4 className=' relative z-10 text-2xl pb-10 max-w-[850px]'>Urakoitsija uusimaalla rakennusliikkeille, yrityksille ja yksityisille. Urakat valmiiksi tehokkaasti, nopealla aikataululla</h4>
